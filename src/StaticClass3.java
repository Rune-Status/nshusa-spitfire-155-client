            ...
            for (i_8 = 0; i_8 < 64; i_8++)
                for (i_9 = 0; i_9 < 64; i_9++)
                    if (i_1 + i_8 > 0 && i_1 + i_8 < 103 && i_2 + i_9 > 0 && i_2 + i_9 < 103)
                        arr_5[i_7].intArrayArray10[i_8 + i_1][i_9 + i_2] &= ~0x1000000;
        ...
        for (int i_10 = 0; i_10 < 8; i_10++)
            for (i_11 = 0; i_11 < 8; i_11++)
                if (i_2 + i_10 > 0 && i_10 + i_2 < 103 && i_11 + i_3 > 0 && i_3 + i_11 < 103)
                    arr_8[i_1].intArrayArray10[i_10 + i_2][i_11 + i_3] &= ~0x1000000;
            ...
            if (i_5 == 22) {
                ...
                if (i_5 >= 12) {
                    ...
                    if (loctype_9.int520 != 0 && collisionmap_7 != null)
                        collisionmap_7.method236(i_1, i_2, i_10, i_11, loctype_9.bool54);
        ...
        if (i_6 == 22) {
            ...
            if (i_6 >= 12) {
                ...
                if (loctype_10.int520 != 0)
                    collisionmap_8.method236(i_2, i_3, i_11, i_12, loctype_10.bool54);

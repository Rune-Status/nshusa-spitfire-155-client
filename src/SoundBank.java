public class SoundBank {
    ...
    public SoundBank(Js5Index js5index_1, Js5Index js5index_2) {
        sfx = js5index_1;
        sfx1 = js5index_2;
    }

    MusicNote method156(int i_1, int i_2, int[] ints_3) {
    ...
    MusicNote method157(int i_1, int i_2, int[] ints_3) {
        int i_5 = i_2 ^ (i_1 << 4 & 0xffff | i_1 >>> 12);
        i_5 |= i_1 << 16;
    ...
    public MusicNote method158(int i_1, int[] ints_2) {
        if (sfx.numGroups() == 1)
            return method156(0, i_1, ints_2);
        else if (sfx.numFiles(i_1) == 1)
            return method156(i_1, 0, ints_2);
        else
            throw new RuntimeException();
    }

    public MusicNote method159(int i_1, int[] ints_2) {
        if (sfx1.numGroups() == 1)
            return method157(0, i_1, ints_2);
        else if (sfx1.numFiles(i_1) == 1)

public class InstrumentDef extends Node {
    ...
    MusicNote[] musicNoteArray1 = new MusicNote[128];
    ...
    int[] intArray50 = new int[128];
    int int372;

    static InstrumentDef staticMethod379(Js5Index js5index_0, int i_1) {
    ...
    boolean method490(SoundBank soundbank_1, byte[] bytes_2, int[] ints_3) {
        boolean bool_5 = true;
        int i_6 = 0;

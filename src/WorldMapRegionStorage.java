...
public abstract class WorldMapRegionStorage {
    ...
    void method10(int i_1, int i_2, Buffer buffer_3, int i_4) {
        ...
        if (bool_6)
            shortArrayArrayArray2[0][i_1][i_2] = (short) buffer_3.method439();

        shortArrayArrayArray1[0][i_1][i_2] = (short) buffer_3.method439();
    }
    ...
    void method11(int i_1, int i_2, Buffer buffer_3, int i_4) {
        ...
        int i_12;
        if (bool_7) {
            i_9 = buffer_3.method439();

            for (i_10 = 0; i_10 < i_9; i_10++) {
                int i_11 = buffer_3.method439();
                if (i_11 != 0) {
                    shortArrayArrayArray2[i_10][i_1][i_2] = (short) i_11;
                    i_12 = buffer_3.method439();

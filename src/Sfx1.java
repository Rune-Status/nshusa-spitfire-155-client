public class Sfx1 extends Node {
    ...
    void method423(byte[] bytes_1) {
        ...
        for (int i_4 = 0; i_4 < i_3; i_4++) {
            ...
            buffer_2.method451(bytes_7, 0, i_5);
    ...
    static boolean staticMethod374(Js5Index js5index_0) {
        if (!staticBool48) {
    ...
    static Sfx1 staticMethod375(Js5Index js5index_0, int i_1, int i_2) {
        if (!staticMethod374(js5index_0)) {
            js5index_0.contains(i_1, i_2);
            return null;
        } else {
    ...
    MusicNote method425(int[] ints_1) {
